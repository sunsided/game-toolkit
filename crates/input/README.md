...
Input for [**game-toolkit**](https://github.com/sunsided/game-toolkit): keyboard, mouse and
gamepads with held / just-pressed / just-released semantics, gamepad hot-plug and rumble (via
